...
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=1 python tools/train.py ./configs/SUnet/SUV2ft_base_patch4_window8_512x512_160k_BTR.py --work-dir $WORK_DIR --gpu-ids 0
