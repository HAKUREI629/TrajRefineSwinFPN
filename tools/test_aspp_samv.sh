...
export NAME=26dB
export WORK_DIR=${OUTPUT_DIR}/diffDoA/testsimSAMV16000/${NAME}/
...
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=0 python tools/test.py ./configs/swin/fpnasppv5_swin_base_patch4_window7_512x512_160k_BTR_testSAMV.py $CKPT --show-dir $WORK_DIR
...
export WORK_DIR=${OUTPUT_DIR}/diffDoA/testsimSAMV32000/${NAME}/
export PYTHONPATH=/wangyunhao/cds/wangyunhao/code/BTR/pytorch-deeplab-xception-v1/Swin-Transformer-Semantic-Segmentation-swin/
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=1 python tools/test.py ./configs/swin/fpnasppv5_swin_base_patch4_window7_512x512_160k_BTR_testSAMV.py $CKPT --show-dir $WORK_DIR
#python tools/calculatetrace.py --input $WORK_DIR --truth $TRUTH --single 0
python tools/calculatetrace.py --input $WORK_DIR --truth tools/truth.mat --single 1

export CKPT=${OUTPUT_DIR}/iter_48000.pth
export WORK_DIR=${OUTPUT_DIR}/diffDoA/testsimSAMV48000/${NAME}/
export PYTHONPATH=/wangyunhao/cds/wangyunhao/code/BTR/pytorch-deeplab-xception-v1/Swin-Transformer-Semantic-Segmentation-swin/
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=1 python tools/test.py ./configs/swin/fpnasppv5_swin_base_patch4_window7_512x512_160k_BTR_testSAMV.py $CKPT --show-dir $WORK_DIR
...
export WORK_DIR=${OUTPUT_DIR}/diffDoA/testsimSAMV64000/${NAME}/
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=1 python tools/test.py ./configs/swin/fpnasppv5_swin_base_patch4_window7_512x512_160k_BTR_testSAMV.py $CKPT --show-dir $WORK_DIR
#python tools/calculatetrace.py --input $WORK_DIR --truth $TRUTH --single 0
...
export WORK_DIR=${OUTPUT_DIR}/diffDoA/testsimSAMV80000/${NAME}/
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=1 python tools/test.py ./configs/swin/fpnasppv5_swin_base_patch4_window7_512x512_160k_BTR_testSAMV.py $CKPT --show-dir $WORK_DIR
#python tools/calculatetrace.py --input $WORK_DIR --truth $TRUTH --single 0
...
export WORK_DIR=${OUTPUT_DIR}/diffDoA/testsimSAMV96000/${NAME}/
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=1 python tools/test.py ./configs/swin/fpnasppv5_swin_base_patch4_window7_512x512_160k_BTR_testSAMV.py $CKPT --show-dir $WORK_DIR
#python tools/calculatetrace.py --input $WORK_DIR --truth $TRUTH --single 0
