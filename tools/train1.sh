...
export MODEL=swindualv2.fpn.doublelabel
...
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=1 python tools/train.py ./configs/swin/fpn_dualswinv2_base_patch4_window7_512x512_160k_BTRdoublelabel.py --work-dir $WORK_DIR --gpu-ids 0