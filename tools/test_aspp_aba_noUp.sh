...
export OUTPUT_DIR=./outputs/seg/swin.fpnasppv5/02-28-01:27:46
export NAME=29dB
...
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=0 python tools/test.py ./configs/swin/fpnasppv5_swin_base_patch4_window7_512x512_160k_BTR_testCBF_ablationnoUp.py $CKPT --show-dir $WORK_DIR
