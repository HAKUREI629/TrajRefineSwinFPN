...
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=0 python tools/train.py ./configs/swin/fpn_swin_base_patch4_window7_512x512_160k_BTR.py --work-dir $WORK_DIR --gpu-ids 0
