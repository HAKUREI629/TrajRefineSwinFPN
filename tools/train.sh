...
export MODEL=deeplabv3plus.r50
...
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=0 python tools/train.py ./configs/deeplabv3plus/deeplabv3plus_r50-d8_512x512_160k_BTR.py --work-dir $WORK_DIR --gpu-ids 0
