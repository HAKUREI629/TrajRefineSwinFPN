...
export OUTPUT_DIR=./outputs/seg/swin.fpnsrbcrb/02-25-06:38:07
...
rm -r ${WORK_DIR}
mkdir -p ${WORK_DIR}
CUDA_VISIBLE_DEVICES=0 python tools/test.py ./configs/swin/fpnsrbcrb_swin_base_patch4_window7_512x512_160k_BTR_testCBF.py $CKPT --show-dir $WORK_DIR
