_base_ = [
    '../_base_/models/fpnasppv5_swin.py', '../_base_/datasets/BTR_testCBF512_5.py',
...
model = dict(
    ...
    decode_head=dict(type='FPNASPPHeadv5gai1_noASPP', in_channels=[128, 256, 512, 1024], num_classes=2)
)
