...
class DecoderCup(nn.Module):
    def __init__(self, decoder_channels, skip_channels, n_skip):
        super().__init__()
        # self.config = config
        head_channels = 1024
        ...
        if n_skip != 0:
            ...
            for i in range(4-n_skip):  # re-select the skip channels according to n_skip 4
...
class STUnetHead(BaseDecodeHead):
    ...
    def __init__(self,
                 ...
                 zero_head=False,
                 **kwargs):
        super(STUnetHead, self).__init__(**kwargs)
        self.zero_head = zero_head

        self.decoder = DecoderCup(decoder_channels, skip_channels, n_skip)
